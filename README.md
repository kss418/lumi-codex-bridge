...
대화 텍스트는 캐릭터별로 로컬에 저장되며, 재실행 시 최근 기록(최대 40,000자)을 참고해 이어갑니다. 저장·참고 횟수는 각각 최대 50회까지 설정할 수 있습니다(기본 저장 50회·참고 20회). 각 대사는 최대 4,000자까지 저장하고 화면 이미지는 저장하지 않습니다. 설정의 **대화 기록** 탭에서 새 대화를 시작하거나 기록을 삭제할 수 있습니다.
