...
- 현재는 일반 텍스트 대화이며, 캐릭터 페르소나를 전달합니다. 수동 화면 보기를 지원하며, 자동 화면 인식·음성 합성은 아직 없습니다.
...
캐릭터 우클릭 → **바탕화면 보기**를 누르면 해당 꼬미가 있는 모니터를 한 번 캡처하고, 현재 대화에 이미지로 첨부합니다. 답변은 꼬미 말풍선에 표시되며 이후 대화에서 화면 내용을 이어서 물어볼 수 있습니다.

- 주기적 촬영은 하지 않습니다. 클릭했을 때만 촬영합니다.
